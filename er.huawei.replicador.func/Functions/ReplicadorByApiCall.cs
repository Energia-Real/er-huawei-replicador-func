...
public class ReplicadorByApiCall
{
    private readonly ILogger _logger;

    public ReplicadorByApiCall(ILoggerFactory loggerFactory)
    {
        _logger = loggerFactory.CreateLogger<ReplicadorByApiCall>();
    }

    [Function("ReplicadorByApiCall")]
